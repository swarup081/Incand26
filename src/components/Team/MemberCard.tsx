...
export const MemberCard = ({
    ...
    return (
        <div className={`relative w-[70vw] h-[115vw] md:w-[40vw] md:h-[65.5vw] lg:w-[23.2vw] lg:h-[38vw] shrink-0 group ${className ?? ""}`}>
            ...
            {/* Profile Image */}
            <img
                className="absolute top-[30.6%] left-[20.8%] w-[58.5%] aspect-square rounded-[3.5vw] md:rounded-[1.5vw] lg:rounded-[1vw] border-[1vw] md:border-[0.5vw] lg:border-[0.3vw] border-solid border-black object-cover z-10 transition-transform duration-300 group-hover:scale-125 group-hover:-translate-y-[2vw] group-hover:drop-shadow-2xl"
                alt={name}
                src={profileImage}
            />
            ...
            <div className="inline-flex items-center gap-[12vw] md:gap-[5vw] lg:gap-[3.5vw] absolute top-[79.5%] left-1/2 -translate-x-1/2 z-20 transition-transform duration-300 group-hover:translate-y-[2vw] group-hover:scale-110">
                {socialIcons.map((icon, iconIndex) => (
                    <a
                        ...
                        className="relative w-[12vw] h-[12vw] md:w-[5vw] md:h-[5vw] lg:w-[3.5vw] lg:h-[3.5vw] flex items-center justify-center transition-transform hover:scale-110 active:scale-95"
                    >
                        <img
            ...
            <div className="flex flex-col items-center gap-[1vw] md:gap-[0.5vw] lg:gap-[0.3vw] absolute top-[68%] left-1/2 -translate-x-1/2 w-[60%] z-20 transition-transform duration-300 group-hover:translate-y-[1vw] group-hover:scale-110">
                <h3 className="font-[Futura_Display-Regular,Helvetica] font-normal text-black text-[5.5vw] md:text-[2.5vw] lg:text-[1.6vw] text-center leading-none">
                    {name}
                </h3>
                <p className="font-hitchcut font-normal text-black text-[2.8vw] md:text-[1.2vw] lg:text-[0.8vw] text-center leading-none">
                    {role}
                </p>
            </div>
        </div>
