    ...
    <>
      ...
      {isLap && (
       ...
       {/* ===== ONE GLOBAL WRAPPER ===== */}
        <div className="relative top-[4vh] right-[2vw] flex scale-[0.9] flex-col items-center">
         ...
         {/* --- SUN  --- */}
         <div className="absolute top-[3vh] left-1/2 -translate-x-1/2 h-[60vh] w-[60vh] rounded-full bg-white" />
        ...
        <div className="relative left-[0.5vw] flex items-start">
          ...
          {/* RIGHT: 2026 */}
          <div className="group relative right-[8vw] scale-[0.97] -top-[1.2vh] cursor-pointer">
            {/* NORMAL 2026 */}
            <Image
      ...
      {isIpad && (
       ...
       {/* ===== ONE GLOBAL WRAPPER ===== */}
         ...
         {/* --- SUN --- */}
         <div className="absolute top-[18vh] left-1/2 -translate-x-1/2 h-[38vh] w-[38vh] rounded-full bg-white" />
      ...
      {isPhone && (
       ...
       {/* ===== ONE GLOBAL WRAPPER ===== */}
         ...
         {/* --- SUN --- */}
         <div className="absolute top-[22vh] left-1/2 -translate-x-1/2 h-[28vh] w-[28vh] rounded-full bg-white" />
