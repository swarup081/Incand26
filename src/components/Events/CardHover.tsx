...
const CardHover = ({ upperImage, lowerImage, eventName }: CardHoverProps) => {
  return (
    <div className="group relative h-72 w-full cursor-pointer overflow-hidden rounded-3xl border-6 border-[#000000] bg-white">
